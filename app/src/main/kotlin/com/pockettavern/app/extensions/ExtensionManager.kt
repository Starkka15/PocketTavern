...
class ExtensionManager @Inject constructor(
    ...
    val charSettingsDefs: StateFlow<Map<String, List<JsExtensionHost.CharSettingField>>> get() = jsHost.charSettingsDefs

    /** Panel registrations from JS extensions (extensionId → PanelRegistration). */
